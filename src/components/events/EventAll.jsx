...
//       <h2 className="text-center mb-5">Our Events</h2>
//       <UpcomingEvents />
//       <hr className="my-5" />
//       <PastEvents />
//     </section>
    ...
    <section style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Explore our upcoming conferences and past events that shape the future of education
        </p>
      </div>
