...
import videoBg from "../../assets/img/home_1/youtube.jpg";
...
export const VideoOne = () => {
  return (
    <section>
      ...
      >
        <div className="container">
          <VideoPlayer
            trigger={
              <a
                href="https://www.youtube.com/watch?v=n4MShOzVT_s"
          ...
          <h2
            className="td_fs_48 td_color bg-white mb-0 wow fadeInUp "
            data-wow-duration="1s"
            data-wow-delay="0.2s"
      ...
      >
        <div className="td_contact_box td_style_1 td_accent_bg td_radius_10 mb-5">
